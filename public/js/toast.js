...
// Prevent redeclaration errors if the script is accidentally included multiple times
if (typeof window.toast === "undefined") {
  class Toast {
    constructor() {
      this.container = null;
      this.toasts = [];
      // Removed this.init() from here so it doesn't run before the DOM body exists
    }
    ...
    show(message, type = "info", duration = 4000) {
      // Lazy initialization: ensure DOM exists before trying to append
      this.init();
